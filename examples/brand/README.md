...
The logo lab records the identity decision. Break Frame is the selected production mark; the other
concepts remain archived explorations outside the published `@drever/brand` package.
