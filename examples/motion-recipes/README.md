...
This fifteen-slide deck moves from stable native View Transitions to semantic
presentation choreography. It is intentionally network-free and uses Drever
primitives, the Editorial theme, canonical Drever brand tokens and fonts, CSS,
and one local SVG.
...
Open <http://localhost:4322>. The continuity recipes occupy paired routes
