...
const PACKAGE = "@drever/theme-editorial";
...
export const theme = defineTheme({
  ...
  motion: {
    ...
    guidance: [
      ...
      "Editorial motion uses a restrained reading-edge crop so evidence feels uncovered rather than mechanically translated.",
  ...
  layouts: [
    {
      ...
      example:
        '<Masthead kicker="Drever / Field Notes" title="The slide is becoming software." deck="A presentation can be interactive, testable, and ready to ship." meta="Zhuo · 2026" />',
    },
    {
      name: "Feature",
