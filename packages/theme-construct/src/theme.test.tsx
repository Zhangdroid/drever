...
describe("@drever/theme-construct", () => {
  it("resolves a complete theme contract and public layout registry", () => {
    ...
    expect(result.value.runtime.styles).toEqual([
      {
        owner: { kind: "theme", id: "@drever/theme-construct" },
        style: { specifier: "@drever/theme-construct/theme.css", layer: "theme" },
      },
    ]);
    expect(
      ...
      {
        name: "Prompt",
        module: { specifier: "@drever/theme-construct/layouts", exportName: "Prompt" },
        requiredSlots: ["question"],
      },
      {
        name: "Assembly",
        module: { specifier: "@drever/theme-construct/layouts", exportName: "Assembly" },
