...
const PACKAGE = "@drever/theme-fieldnote";
...
export const theme = defineTheme({
  ...
  tokens: {
    ...
    typography: {
      ...
      body: "Avenir Next, Aptos, Segoe UI, ui-sans-serif, system-ui, sans-serif",
      mono: "SFMono-Regular, Consolas, ui-monospace, monospace",
      titleSize: 88,
      bodySize: 27,
    },
    space: { slideX: 148, slideY: 82, rhythm: 24 },
  ...
  manifest: {
    ...
    summary:
      "A handwritten but disciplined theme for workshops, lessons, tutorials, reflections, and early ideas.",
    artDirection: {
      keywords: ["handwritten", "instructional", "warm", "reflective", "direct"],
      principles: [
        "Reserve handwriting for titles, annotations, and short emphasis",
        "Let ruled paper establish reading order instead of adding scrapbook decoration",
        "Attach every annotation to a visible idea or artifact",
        "Keep body copy, data, and code in highly readable type",
      ],
      avoid: [
        "Coffee stains, tape, random rotation, or decorative doodles",
        "Long paragraphs in handwriting",
