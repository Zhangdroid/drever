...
describe("@drever/theme-fieldnote", () => {
  it("resolves the complete theme, layouts, and motion contract", () => {
    ...
    expect(result.value.runtime.styles).toEqual([
      {
        owner: { kind: "theme", id: "@drever/theme-fieldnote" },
        style: { specifier: "@drever/theme-fieldnote/theme.css", layer: "theme" },
      },
    ]);
    expect(
