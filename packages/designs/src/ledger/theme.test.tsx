...
describe("@drever/designs/ledger", () => {
  it("resolves a JSON-safe theme contract and its public layout registry", () => {
    ...
    expect(result.value.runtime.styles).toEqual([
      {
        owner: { kind: "theme", id: "@drever/designs/ledger" },
        style: { specifier: "@drever/designs/ledger/theme.css", layer: "theme" },
      },
    ]);
    expect(
      ...
      {
        name: "Metric",
        module: { specifier: "@drever/designs/ledger/layouts", exportName: "Metric" },
        requiredSlots: ["label", "value", "context"],
      },
      {
        name: "Evidence",
        module: { specifier: "@drever/designs/ledger/layouts", exportName: "Evidence" },
  ...
  it("keeps CSS aligned with tokens and covers semantics, data, motion, and layouts", () => {
    const css = readFileSync(new URL("../../themes/ledger/theme.css", import.meta.url), "utf8");
