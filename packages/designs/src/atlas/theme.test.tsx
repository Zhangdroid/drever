...
describe("@drever/designs/atlas", () => {
  it("resolves a complete theme contract and public layout registry", () => {
    ...
    expect(result.value.runtime.styles).toEqual([
      {
        owner: { kind: "theme", id: "@drever/designs/atlas" },
        style: { specifier: "@drever/designs/atlas/theme.css", layer: "theme" },
      },
    ]);
    expect(
      ...
      {
        name: "Route",
        module: { specifier: "@drever/designs/atlas/layouts", exportName: "Route" },
        requiredSlots: ["title", "origin", "waypoints", "destination"],
      },
      {
        name: "Survey",
        module: { specifier: "@drever/designs/atlas/layouts", exportName: "Survey" },
  ...
  it("keeps CSS metadata aligned and covers semantic, motion, and layout states", () => {
    const css = readFileSync(new URL("../../themes/atlas/theme.css", import.meta.url), "utf8");
