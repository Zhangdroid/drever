...
export const theme = defineTheme({
  ...
  tokens: {
    ...
    typography: {
      display:
        "Inter, Aptos, SF Pro Display, Segoe UI Variable Display, ui-sans-serif, system-ui, sans-serif",
      body: "Inter, Aptos, Segoe UI Variable, ui-sans-serif, system-ui, sans-serif",
  ...
  motion: {
    ...
    guidance: [
      ...
      "Basic uses mostly direct cuts and quiet fades; short spatial travel is exceptional and content remains more prominent than choreography.",
