...
describe("@drever/designs/cinema", () => {
  it("resolves a complete theme contract and its public layout registry", () => {
    ...
    expect(result.value.runtime.styles).toEqual([
      {
        owner: { kind: "theme", id: "@drever/designs/cinema" },
        style: { specifier: "@drever/designs/cinema/theme.css", layer: "theme" },
      },
    ]);
    expect(
      ...
      {
        name: "TitleCard",
        module: { specifier: "@drever/designs/cinema/layouts", exportName: "TitleCard" },
        requiredSlots: ["title"],
      },
      {
        name: "Frame",
        module: { specifier: "@drever/designs/cinema/layouts", exportName: "Frame" },
        requiredSlots: ["media"],
      },
    ]);
  });
  ...
  it("keeps CSS tokens aligned with metadata and media motion geometry stable", () => {
    const css = readFileSync(new URL("../../themes/cinema/theme.css", import.meta.url), "utf8");
