...
describe("@drever/designs/editorial", () => {
  it("resolves a complete theme contract and its public layout registry", () => {
    ...
    expect(result.value.runtime.styles).toEqual([
      {
        owner: { kind: "theme", id: "@drever/designs/editorial" },
        style: { specifier: "@drever/designs/editorial/theme.css", layer: "theme" },
      },
    ]);
    ...
    expect(
      ...
      {
        name: "Masthead",
        module: { specifier: "@drever/designs/editorial/layouts", exportName: "Masthead" },
        requiredSlots: ["title"],
      },
      {
        name: "Feature",
        module: { specifier: "@drever/designs/editorial/layouts", exportName: "Feature" },
  ...
  it("keeps CSS tokens aligned with metadata and covers core content states", () => {
    const css = readFileSync(new URL("../../themes/editorial/theme.css", import.meta.url), "utf8");
