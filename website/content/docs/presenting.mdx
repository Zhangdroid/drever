...
On a narrow portrait screen, Drever preserves the authored canvas instead of unpredictably
reflowing it. The viewer offers a quiet choice to rotate for the live deck or open the same content
in Document View, and the complete command bar remains horizontally reachable.
