...
test("the built CLI installs an idempotent agent kit without loading project config", async () => {
  ...
  try {
    ...
    expect(first.stdout).toBe("Synced Drever agent kit: 11 created, 1 updated, 0 unchanged.\n");
    ...
    expect(second.stdout).toBe("Synced Drever agent kit: 0 created, 0 updated, 12 unchanged.\n");
